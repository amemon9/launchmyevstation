# Launch My evstation: Google remote MCP demo 
...
> **"How would you help a friend launch a new high-end super evstation in Los Angeles?"**
...
*   Creates the `mcp_evstation` BigQuery dataset.
...
Open the link provided by `adk web` in your browser. You can now chat with the agent and ask it questions about the evstation data.
